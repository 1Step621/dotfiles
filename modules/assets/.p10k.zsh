# Generated by Powerlevel10k configuration wizard on 2026-03-19 at 01:49 JST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-v3 + powerline, small icons, rainbow, unicode,
# vertical separators, flat heads, flat tails, 1 line, compact, few icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      typeset -g my_git_format=${VCS_STATUS_LOCAL_BRANCH}
      return
    fi

    if [[ -n $VCS_STATUS_TAG ]]; then
      typeset -g my_git_format="#${VCS_STATUS_TAG}"
      return
    fi

    typeset -g my_git_format="@${VCS_STATUS_COMMIT[1,8]}"
  }
